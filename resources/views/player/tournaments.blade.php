    ...
    <div class="space-y-6">
        <x-ui.card class="bg-[linear-gradient(90deg,#10213d_0%,#11325a_45%,#156b63_100%)] text-white">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <p class="text-xs uppercase tracking-[0.2em] text-emerald-100/80">Player Tournaments</p>
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
            @forelse($tournaments as $tournament)
                <x-ui.card>
                    ...
                    <h3 class="mt-2 text-xl font-black text-white">{{ $tournament->title }}</h3>
